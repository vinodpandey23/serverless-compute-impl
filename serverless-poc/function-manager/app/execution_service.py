...
class ExecutionService:
    def __init__(self, cleanup_service=None):
    ...
    def execute_function(self, function_name, payload):
        ...
        if container and container.status == 'running':
            ...
            if self.cleanup_service:
                self.cleanup_service.register_container(function_name,
                                                        container)
    ...
    def _invoke_function(self, container, function_name, payload):
        try:
            ...
            if exec_result.exit_code == 0:
                ...
                logger.error(
                    f"Function execution failed with exit code: "
